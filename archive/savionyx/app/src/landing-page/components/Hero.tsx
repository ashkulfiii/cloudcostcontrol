...
import { AppUrl } from '../../shared/common';
        ...
        <div className='mx-auto max-w-8xl px-6 lg:px-8'>
          <div className='lg:mb-18 mx-auto max-w-3xl text-center'>
            <h1 className='text-4xl font-bold text-gray-900 sm:text-6xl dark:text-white'>
              Control Your Azure Cloud Costs <span className='italic'>Effortlessly</span>
            </h1>
            <p className='mt-6 mx-auto max-w-2xl text-lg leading-8 text-gray-600 dark:text-white'>
              Simplify cloud cost management with understandable dashboards, executive summaries and accurate forecasts. Empower your team to control expenses with ease!
            </p>
